...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        <div style="float: left; width: 300px;">
            <div class="sideLogin">
                <div class="welcome">Welcome To Fresh Fruit Mart</div>
                <p>
                    At Fresh Fruit Mart our goal is to provide you with the wide varieties of Fruits and Vegetables.
                </p>
                <table>
                    <tr>
                        <td>UserName
                ...
                <div class="contact_informatin">
                    ...
                    <table class="call">
                        <tr>
                            ...
                            <td>+91-9936716435 / +91-6392564708</td>
                        </tr>
                        <tr>
                            <td>
                                <img src="images/contact_icon.gif" alt="" title="" class="icon">
                            </td>
                            <td>dayagupta9936@gmail.com / freshfruitmart@gmail.com </td>
                             <td> </td>
                        </tr>
                    </table>
